...
public class viewkamusTest {
    ...
    /**
     * Test of printpilihanbahasa method, of class viewkamus.
     */
    @Test
    public void testPrintpilihanbahasa() {
        System.out.println("printpilihanbahasa");
        Scanner in = null;
        String[] bahasa = null;
        String bahasadef = "";
        int jumlah = 0;
        viewkamus instance = new viewkamus();
        int expResult = -1;
        int result = instance.printpilihanbahasa(in, bahasa, bahasadef, jumlah);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        //fail("The test case is a prototype.");
    }
    ...
    /**
     * Test of printbahasadef method, of class viewkamus.
     */
    @Test
    public void testPrintbahasadef() {
        System.out.println("printbahasadef");
        String bahasadef = "";
        viewkamus instance = new viewkamus();
        instance.printbahasadef(bahasadef);
        // TODO review the generated test code and remove the default call to fail.
        //fail("The test case is a prototype.");
    }
